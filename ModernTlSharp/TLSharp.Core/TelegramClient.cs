...
using ModernTlSharp.TLSharp.Tl.TL.Auth;
using ModernTlSharp.TLSharp.Tl.TL.Contacts;
using ModernTlSharp.TLSharp.Tl.TL.Help;
using ModernTlSharp.TLSharp.Tl.TL.Messages;
using ModernTlSharp.TLSharp.Tl.TL.Upload;
using ModernTlSharp.TLSharp.Core.Auth;
using ModernTlSharp.TLSharp.Core.Exceptions;
using ModernTlSharp.TLSharp.Core.Network;
using ModernTlSharp.TLSharp.Core.Network.Exceptions;
using ModernTlSharp.TLSharp.Core.Utils;
using TLAuthorization = ModernTlSharp.TLSharp.Tl.TL.Auth.TLAuthorization;
using ModernTlSharp.TLSharp.Tl;

namespace ModernTlSharp.TLSharp.Core
{
    public class TelegramClient : IDisposable
    {
        private MtProtoSender sender;
        private TcpTransport transport;
        private readonly string apiHash = string.Empty;
        private readonly int apiId = 0;
        ...
        public async Task ConnectAsync(bool reconnect = false, CancellationToken token = default)
        {
        ...
        internal async Task<T> SendAuthenticatedRequestAsync<T> (Tl.TLMethod methodToExecute, CancellationToken token = default)
        {
            if (!IsUserAuthorized())
        ...
        {
            var r = new Tl.TL.Contacts.TLRequestSearch
            {
                Q = q,
                Limit = limit
            };
